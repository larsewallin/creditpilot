...
| `total_outstanding`    | Sum of current + aging buckets | Computed | bigint. Note: excludes pre_petition_amount (see backlog F4). Portfolio total: 77,897,000 from `v_ar_aging_portfolio`; true exposure including pre_petition is 80,140,000. |
